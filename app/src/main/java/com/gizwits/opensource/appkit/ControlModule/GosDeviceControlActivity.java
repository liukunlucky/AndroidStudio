...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private TextView tv_data_Remaining_Pack;
	private SeekBar sb_data_Remaining_Pack;
	private TextView tv_data_Lid_State;
	private TextView tv_data_D_Remaining_Pack;
	private EditText et_extend_Dosing_Time;
	...
	private void initView() {
		...
		tv_data_Remaining_Pack = (TextView) findViewById(R.id.tv_data_Remaining_Pack);
		sb_data_Remaining_Pack = (SeekBar) findViewById(R.id.sb_data_Remaining_Pack);
		tv_data_Lid_State = (TextView) findViewById(R.id.tv_data_Lid_State);
		tv_data_D_Remaining_Pack = (TextView) findViewById(R.id.tv_data_D_Remaining_Pack);
		et_extend_Dosing_Time = (EditText) findViewById(R.id.et_extend_Dosing_Time);
	}

	private void initEvent() {

		sb_data_Remaining_Pack.setOnSeekBarChangeListener(this);
		et_extend_Dosing_Time.setOnEditorActionListener(this);
		et_extend_Dosing_Time.addTextChangedListener(new HexWatcher(et_extend_Dosing_Time));
	...
	public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
		...
		switch (v.getId()) {
		case R.id.et_extend_Dosing_Time:
			sendCommand(KEY_DOSING_TIME, HexStrUtils.hexStringToBytes(v.getText().toString().replaceAll(" ", "")));
			break;
		default:
			break;
		}
	...
	public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
		...
		case R.id.sb_data_Remaining_Pack:
			tv_data_Remaining_Pack.setText(formatValue((progress + REMAINING_PACK_OFFSET) * REMAINING_PACK_RATIO + REMAINING_PACK_ADDITION, 1));
			break;
		default:
			break;
		}
	...
	public void onStopTrackingTouch(SeekBar seekBar) {
		switch (seekBar.getId()) {
		case R.id.sb_data_Remaining_Pack:
			sendCommand(KEY_REMAINING_PACK, (seekBar.getProgress() + REMAINING_PACK_OFFSET ) * REMAINING_PACK_RATIO + REMAINING_PACK_ADDITION);
			break;
		default:
			break;
		}
	...
	protected void updateUI() {
		...
		tv_data_Remaining_Pack.setText(data_Remaining_Pack+"");
		sb_data_Remaining_Pack.setProgress((int)((data_Remaining_Pack - REMAINING_PACK_ADDITION) / REMAINING_PACK_RATIO - REMAINING_PACK_OFFSET));
		tv_data_Lid_State.setText(data_Lid_State+"");
		tv_data_D_Remaining_Pack.setText(data_D_Remaining_Pack+"");
		setEditText(et_extend_Dosing_Time, HexStrUtils.bytesToHexString(data_Dosing_Time));
